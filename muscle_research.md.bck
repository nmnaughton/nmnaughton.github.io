...
I work on measuring this microstructure using diffusion-weighted magnetic resonance imaging (dMRI) and connecting this microstructure to effective mechanical properties of muscle. This work can be broadly organized as three separate but interrelated problems:  
